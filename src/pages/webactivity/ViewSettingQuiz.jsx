...
const ViewSettingQuiz = ({ form, onStepChange, start_image, background_image, title_image, content_image,
    ...
    return (
        ...
        >
            ...
            <Form.Item required label="考題－文字色" name="question_font_color"
                rules={[
                    {
                        required: true,
                        message: '請輸入考題－文字色!',
...
export default ViewSettingQuiz;