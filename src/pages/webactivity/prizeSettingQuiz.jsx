...
const PrizeSettingQuiz = ({ form, onStepChange, win_image, no_win_image, cd_image, prize_image, setPrize_image,
    uploadButton, getFile, beforeUpload, handlePreview, handleChange, save }) => {

    const onFinish = (values) => {
        console.log('步骤 3:', values);
        onStepChange(4, values,"save");
    };
            ...
            <Title level={3}>獎項設定</Title>
            {
                prize_image.map((value, index) => (
                    <>
                        ...
                        >
                            <Select placeholder="請選擇得獎選項。。。" options={[{ label: 'A', value: 'A' }, { label: 'B', value: 'B' }]} />
                        </Form.Item>
...
export default PrizeSettingQuiz;